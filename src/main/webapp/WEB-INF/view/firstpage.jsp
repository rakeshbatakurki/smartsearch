...
<body>
	...
	<form autocomplete="off" action="/result" method="post">
		...
		<div class="autocomplete" style="width: 300px;">
			<input id="myInput" type="text" placeholder="Enter Something"
				name="searchString"
				oninput="fetchSuggestions(document.getElementById('myInput').value);">
		</div>
	...
	<div id="container">
		<div id="content">
			<table>
				<c:forEach var="tempWebDetails" items="${webdetail}">
					<tr class="card">
						<td class="container">${tempWebDetails.title}<br>
							${tempWebDetails.details}
						</td>
					</tr>
					<%-- <tr>
						<td>${tempWebDetails.details}</td>
					</tr> --%>
					<tr>
						<td><br></td>
					</tr>
	...
	<c:forEach var="i" begin="1" end="${numberOfPages}">
		<div class="pagination">
			<a href="/result/${searcgString}/${i}">${i}</a>
		</div>
	</c:forEach>
